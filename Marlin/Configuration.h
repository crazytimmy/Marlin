...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb-crazytimmy, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 CR-Touch"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5, -0.23 }
